...
public class CovidNewsFragmentActivity extends Fragment {
    String api = "b4904842e33645bc9ec0b619dd8dc3c3";
    ArrayList<ModelClass> modelClassArrayList;
    NewsAdapterToDisplay adapter;
    String country = "my";
    private RecyclerView recyclerViewOfCovid;
    private String category = "health";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.activity_covid_news_fragment,null);

        recyclerViewOfCovid=view.findViewById(R.id.recyclerViewForCovidNewsFragment);
        modelClassArrayList=new ArrayList<>();
        recyclerViewOfCovid.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new NewsAdapterToDisplay(getContext(),modelClassArrayList);
        recyclerViewOfCovid.setAdapter(adapter);
